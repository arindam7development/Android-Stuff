...
import app7.mishra.arindam.cloudsapp.MainActivity;
import app7.mishra.arindam.cloudsapp.R;
import app7.mishra.arindam.cloudsapp.Utility;
import app7.mishra.arindam.cloudsapp.data.WeatherContract;
import app7.mishra.arindam.cloudsapp.data.WeatherContract.WeatherEntry;
import app7.mishra.arindam.cloudsapp.data.WeatherContract.LocationEntry;
...
public class CloudsAppSyncAdapter extends AbstractThreadedSyncAdapter {
    public final String LOG_TAG = CloudsAppSyncAdapter.class.getSimpleName();
    ...
    public CloudsAppSyncAdapter(Context context, boolean autoInitialize) {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                // The date/time is returned as a long.  I need to convert that
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        CloudsAppSyncAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);
